...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/AgentToken/subToapi/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/AgentToken/subToapi/blob/main/docs/legal/admin-compliance.en.md"
