...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/AgentToken/subToapi/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="AgentToken/subToapi"
...
Documentation=https://github.com/AgentToken/subToapi
