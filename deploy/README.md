...
curl -sSL https://raw.githubusercontent.com/AgentToken/subToapi/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/AgentToken/subToapi/releases)
