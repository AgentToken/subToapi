...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/AgentToken/subToapi/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/AgentToken/subToapi/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/AgentToken/subToapi/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/AgentToken/subToapi/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
