...
```bash
curl -sSL https://raw.githubusercontent.com/AgentToken/subToapi/main/deploy/install.sh | sudo bash
```
...
# アンインストール
curl -sSL https://raw.githubusercontent.com/AgentToken/subToapi/main/deploy/install.sh | sudo bash -s -- uninstall -y
```
...
curl -sSL https://raw.githubusercontent.com/AgentToken/subToapi/main/deploy/docker-deploy.sh | bash
...
```bash
# 1. リポジトリをクローン
git clone https://github.com/AgentToken/subToapi.git
cd sub2api/deploy
...
<a href="https://star-history.dera.page/#AgentToken/subToapi&Date">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=AgentToken/subToapi&type=Date&theme=dark" />
   <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=AgentToken/subToapi&type=Date" />
   <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=AgentToken/subToapi&type=Date" />
 </picture>
</a>
